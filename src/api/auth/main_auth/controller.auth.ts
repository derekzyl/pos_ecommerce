...
import { signupFactory } from "./factory.auth";
import { CreateUserT } from "../interface_auth/interface.auth";
...
export const signup = async (
  ...
  try {
    const body: CreateUserT = request.body;
    const phone_signup = await signupFactory(request, body);
